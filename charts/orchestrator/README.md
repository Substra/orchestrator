...
| `fabric.channels`                   | A list of Hyperledger Fabric channels to connect to. See [hlf-k8s](https://github.com/owkin/connect-hlf-k8s) | `["mychannel","yourchannel"]`                           |
...
| `orchestrator.image.tag`                         | `orchestrator` image tag                                                                                                                                                 | `0.19.0`                             |
...
| `forwarder.image.tag`           | Event forwarder image tag                                                                  | `0.19.0`                                |
...
| `rabbitmqOperator.image.tag`        | RabbitMQ operator image tag                                     | `0.19.0`                                        |
