...
| `orchestrator.image.tag`                         | `orchestrator` image tag                                                                                                                                                 | `0.19.1`                             |
...
| `forwarder.image.tag`           | Event forwarder image tag                                                                  | `0.19.1`                                |
...
| `rabbitmqOperator.image.tag`        | RabbitMQ operator image tag                                     | `0.19.1`                                        |
