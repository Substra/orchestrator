...
| `orchestrator.image.tag`                         | `orchestrator` image tag                                                                                                                                                 | `0.17.0`                             |
...
| `forwarder.image.tag`           | Event forwarder image tag                                                                  | `0.17.0`                                |
...
| `rabbitmqOperator.image.tag`        | RabbitMQ operator image tag                                     | `0.17.0`                                        |
