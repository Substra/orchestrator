...
func TestQueryObjective(t *testing.T) {
	...
	invocator.On("Invoke", "org.substra.objective:QueryObjective", param, &asset.Objective{}).Return(nil)
...
func TestQueryObjectives(t *testing.T) {
	...
	invocator.On("Invoke", "org.substra.objective:QueryObjectives", param, &asset.ObjectivesQueryResponse{}).Return(nil)
