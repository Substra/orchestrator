...
// Limiter implements RequestScheduler interface and
...
// NewLimiter returns a RequestScheduler instance ready to use.
...
func (c *Limiter) AcquireExecutionToken() <-chan ExecutionToken {
